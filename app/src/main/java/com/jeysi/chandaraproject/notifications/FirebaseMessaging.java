...
import com.jeysi.chandaraproject.ChatActivity;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (notificationType.equals("PostNotification")){
            ...
            //if user is sanme that has posted dont show notif
            ...
            Toast.makeText(this, "Failed Notification...", Toast.LENGTH_SHORT).show();
    ...
    public void onNewToken(String token) {
        ...
        //
        //String onNewToken = com.google.firebase.messaging.FirebaseMessaging.getInstance().getToken().getResult();
        if (user != null) {
            updateToken(token);
        }
    }
